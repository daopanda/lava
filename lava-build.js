...
var VueLocalize = require('v-localize')
var VueLocalstorage = require('vue-localstorage')
var LocalizeConfig = require('./core/configs/locale_config.js') // Загрузка конфига из файла
...
var singin = require('./views/pages/singin.vue')
var singup = require('./views/pages/singup.vue')
var lava_home = require('./views/pages/lava_home.vue')
var lava_settings = require('./views/pages/lava_settings.vue')

var lava_settings_privacy = require('./views/pages/settings-c/lava_settings_privacy.vue')
var lava_settings_notification = require('./views/pages/settings-c/lava_settings_notification.vue')
var lava_settings_blacklist = require('./views/pages/settings-c/lava_settings_blacklist.vue')
var lava_settings_password = require('./views/pages/settings-c/lava_settings_password.vue')
var lava_settings_general = require('./views/pages/settings-c/lava_settings_general.vue')
// TEMPLATE BLOCKS

// COMPONENTS
var lava_settings_menu = require('./views/pages/settings-c/lava_settings_menu.vue')

var preloader = require('./views/pages/share/preloader.vue')

var auth_header = require('./views/components/auth/auth-header.vue') 
var singup_form = require('./views/components/auth/singup-form.vue')
var singin_form = require('./views/components/auth/singin-form.vue')

var lava_header = require('./views/pages/share/lava_header.vue')
var lava_profile = require('./views/pages/share/lava_profile.vue')
...
const router = new VueRouter({
  ...
  { 'path': '/settings', component: lava_settings,
    children: [
      ...
      { 'path': 'privacy', component:lava_settings_privacy},
      { 'path': 'notification', component: lava_settings_notification},
      { 'path': 'blacklist', component: lava_settings_blacklist },
      { 'path': 'password', component: lava_settings_password }
...
Vue.use(store)
var localize = VueLocalize.config(LocalizeConfig)
// REGISTRATION COMPONENTS
Vue.component('lava-settings-menu', lava_settings_menu)

Vue.component('preloader', preloader)
Vue.component('auth-header', auth_header)
Vue.component('singup-form', singup_form)
Vue.component('singin-form', singin_form)
Vue.component('lava-header', lava_header)
Vue.component('lava-profile', lava_profile)
// MIXIN
...
var app = new Vue({
  ...
  methods: {
    ...
    getUserInfo: function(){
       ...
       this.$http.get(this.$store.api.userobject,{headers: {'X-Auth-Token': this.$store.api.token}}).then( function(response)  {
          ...
          this.$store.userinfo = response.data.result
    ...
    StartApp: function(){
      ...
      if(this.$cookie.get('lava-token')){
        // если пользоатель залогинен
        // получить язык с сервера
        ...
        // если есть куки языка
        if(this.$cookie.get('lava-lang')){
          // получить язык из куки
          this.$locale({l: this.$cookie.get('lava-lang')})
  ...
  created:function(){
    // прочитать cookie
    // на какую страницу пришёл  на ту перенаправить после логина или регистрации
    // прочитать язык интерфейса
...
},{"./core/configs/locale_config.js":2,"./views/components/auth/auth-header.vue":15,"./views/components/auth/singin-form.vue":16,"./views/components/auth/singup-form.vue":17,"./views/pages/lava_home.vue":18,"./views/pages/lava_settings.vue":19,"./views/pages/settings-c/lava_settings_blacklist.vue":20,"./views/pages/settings-c/lava_settings_general.vue":21,"./views/pages/settings-c/lava_settings_menu.vue":22,"./views/pages/settings-c/lava_settings_notification.vue":23,"./views/pages/settings-c/lava_settings_password.vue":24,"./views/pages/settings-c/lava_settings_privacy.vue":25,"./views/pages/share/lava_header.vue":26,"./views/pages/share/lava_profile.vue":27,"./views/pages/share/preloader.vue":28,"./views/pages/singin.vue":29,"./views/pages/singup.vue":30,"v-localize":6,"vee-validate":7,"vue-cookie":8,"vue-localstorage":10,"vue-resource":11,"vue-router":12,"vue/dist/vue.js":13}],2:[function(require,module,exports){
...
!function(e,t){"object"==typeof exports&&"object"==typeof module?module.exports=t():"function"==typeof define&&define.amd?define("Localize",[],t):"object"==typeof exports?exports.Localize=t():e.Localize=t()}("undefined"!=typeof self?self:this,function(){return function(e){function t(o){if(n[o])return n[o].exports;var i=n[o]={i:o,l:!1,exports:{}};return e[o].call(i.exports,i,i.exports,t),i.l=!0,i.exports}var n={};return t.m=e,t.c=n,t.d=function(e,n,o){t.o(e,n)||Object.defineProperty(e,n,{configurable:!1,enumerable:!0,get:o})},t.n=function(e){var n=e&&e.__esModule?function(){return e.default}:function(){return e};return t.d(n,"a",n),n},t.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},t.p="dist/",t(t.s=0)}([function(e,t,n){"use strict";var o,i;i=n(1).install,o=n(4).config,e.exports={install:i,config:o}},function(e,t,n){"use strict";var o,i,r=n(2);o=r.directive;var l=n(3);i=l.locale,e.exports={install:function(e,t){return e.directive("localize",o),e.mixin({methods:{$locale:i}})}}},function(e,t,n){"use strict";e.exports={directive:{unbind:function(e,t,n){var o;return o=n.context.$root.$options.localize,o.nodes.splice(o.nodes.indexOf(o.nodes.find(function(t){return t.el===e})),1)},bind:function(e,t,n){var o,i,r,l,a,c,u;c=n.context.$root.$options.localize,c.nodes.find(function(t){return t.el===e})||c.nodes.push({el:e,binding:t,vm:n});try{a=c.localizations[t.value.t||c.locale],i=t.value.i.match(c.$constants.regex.item);for(l in i)if(o=i[l],void 0===(a=a[o]))throw new Error('Cannot read property for "'+o+'".');if(t.value.attr)return e.setAttribute(t.value.attr,a);if(e.innerHTML=a,(u=c.available.find(function(e){return e.locale===c.locale}))&&(u.orientation&&e.setAttribute("dir",u.orientation),u.font&&(u.font.family&&(e.style.fontFamily=u.font.family),u.font.size)))return e.style.fontSize=u.font.size}catch(n){return r=n,c.$logger.warn('Could not find localization for "'+t.value.i+'" in '+(t.value.t||c.locale)),c.$logger.error(r),t.value.attr?e.setAttribute(t.value.attr,c.fallback):e.innerHTML=c.fallback}}}}},function(e,t,n){"use strict";e.exports={locale:function(){var e,t,n,o,i,r,l=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;if(r=this.$root.$options._base,i=this.$root.$options.localize,!l)return i.locale;if(l.l){if(!i.available.find(function(e){return e.locale||e===l.l}))return i.$logger.error('Locale "'+l.lang+'" not defined in configuration.');if(i.locale=l.l,i.webStore&&window.localStorage.setItem("locale",l.l),i.nodes.forEach(function(e){return r.directive("localize").bind(e.el,e.binding,e.vm)}),"undefined"!=typeof document)return document.querySelector("html").setAttribute("lang",l.l)}else if(l.i){o=i.localizations[l.t||i.locale],t=l.i.match(i.$constants.regex.item);for(n in t)if(e=t[n],void 0===(o=o[e]))throw new Error('Cannot read property for "'+e+'".');return o}}}},function(e,t,n){"use strict";var o,i,r=n(5);i=r.constants;var l=n(7);o=l.Logger,e.exports={config:function(e){var t,n,r;return n=Object.assign({},e),n.$constants=i,n.debug=n.debug||!1,n.$logger=new o(n.debug),n.nodes=[],t=n.available.map(function(e){return e.locale||e}),t.forEach(function(e){if(!n.localizations[e])throw Error('Localizations for locale "'+e+'" not found.')}),n.webStore=n.webStore&&"undefined"!=typeof window,n.webStore?(r=window.localStorage.getItem("locale"),r&&t.find(function(e){return e===r})?n.locale=r:(n.locale=n.default,window.localStorage.setItem("locale",n.locale))):n.locale=n.default,"undefined"!=typeof document&&document.querySelector("html").setAttribute("lang",n.locale),n.fallback=n.fallback||"N/A",n}}},function(e,t,n){"use strict";var o;o=n(6).version,e.exports={constants:{version:o,regex:{item:/([a-zA-Z$]{1,}).*?/g}}}},function(e,t){e.exports={name:"v-localize",version:"1.1.8",description:"Simple localization plugin for the amazing Vue.js.",main:"dist/v-localize.js",directories:{example:"example"},scripts:{bundle:"node_modules/.bin/webpack --config webpack.config.js",lint:"node_modules/.bin/coffeelint -f coffee-lint.json src/**.coffee",test:"node_modules/.bin/karma start test/karma.conf.js",build:"npm run lint && npm run bundle && npm run test"},repository:{type:"git",url:"git+https://github.com/neetjn/v-localize.git"},keywords:["vue","vue.js","localize","javascript","i18n","internationalization","coffeescript"],author:"John Nolette",license:"MIT",bugs:{url:"https://github.com/neetjn/v-localize/issues"},homepage:"https://neetjn.github.io/v-localize/",devDependencies:{babel:"^6.23.0","babel-core":"^6.26.0","babel-eslint":"^8.2.1","babel-loader":"^7.1.2","babel-preset-env":"^1.6.1","coffee-loader":"^0.9.0",coffeelint:"^2.0.7",coffeescript:"^2.2.0",electron:"^1.7.11",jasmine:"2.5.2",karma:"^1.7.1","karma-electron":"^5.2.1","karma-jasmine":"^1.1.0",vue:"^2.5.0",webpack:"^3.8.1"},dependencies:{}}},function(e,t,n){"use strict";function o(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var i,r=function(){function e(e,t){for(var n=0;n<t.length;n++){var o=t[n];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(e,o.key,o)}}return function(t,n,o){return n&&e(t.prototype,n),o&&e(t,o),t}}();i=function(){function e(t){o(this,e),this.debugging=t,this.logs=[],Object.defineProperty(this,"time",{get:function(){return(new Date).getTime()}})}return r(e,[{key:"_format",value:function(e,t){return"["+new Date(t)+']: (v-localize) "'+e+'"'}},{key:"$get",value:function(e){return this.logs.filter(log(function(){return null!=e?e:log.type==={type:!0}}))}},{key:"log",value:function(e){var t;return t=this.time,this.debugging&&console.log(this._format(e,t)),this.logs.push({type:"log",message:t})}},{key:"warn",value:function(e){var t;return t=this.time,this.debugging&&console.warn(this._format(e,t)),this.logs.push({type:"warning",message:t})}},{key:"error",value:function(e){var t;return t=this.time,this.debugging&&console.error(this._format(e,t)),this.logs.push({type:"critical",message:t})}}]),e}(),e.exports={Logger:i}}])});
...
},{"tiny-cookie":5}],9:[function(require,module,exports){
var Vue // late bind
var version
...
},{"got":3}],12:[function(require,module,exports){
(function (process){
/**
  * vue-router v3.0.1
  * (c) 2017 Evan You
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('header',{staticClass:"header"},[_vm._m(0),_vm._v(" "),_c('div',{staticClass:"lang-button"},[_c('div',{directives:[{name:"localize",rawName:"v-localize",value:({i: 'lang.reduction'}),expression:"{i: 'lang.reduction'}"}],staticClass:"lang-button--content"},[_vm._v("eng")]),_vm._v(" "),_c('div',{staticClass:"lang-dropdown"},[_c('div',{staticClass:"lang-dropdown--items"},[_c('div',{staticClass:"lang-dropdown--item",on:{"click":function($event){_vm.changeLang('en-US')}}},[_vm._v("eng")]),_vm._v(" "),_c('div',{staticClass:"lang-dropdown--item",on:{"click":function($event){_vm.changeLang('ru-RU')}}},[_vm._v("рус")])])])])])}
__vue__options__.staticRenderFns = [function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('a',{staticClass:"logotype_link",attrs:{"href":"#"}},[_c('img',{attrs:{"src":"assets/imgs/logo.svg"}}),_vm._v("\n\tLAVA\n\t")])}]
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f9eef420", __vue__options__)
  } else {
    hotAPI.reload("data-v-f9eef420", __vue__options__)
  }
})()}
},{"vue":14,"vue-hot-reload-api":9}],16:[function(require,module,exports){
;(function(){
//
//
//
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('form',{staticClass:"form"},[_c('div',{class:[{ 'input-iserror': _vm.errors.has('email')}, {'input-preload' : _vm.emailValidationPreloader}, { 'input-issucces': _vm.validEmail },  'custom-input' ]},[_c('label',{staticClass:"form-label",attrs:{"for":"registration_email"}},[_vm._v(_vm._s(_vm.$locale({i: 'forms.email'})))]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.email),expression:"email"},{name:"validate",rawName:"v-validate",value:('required|email'),expression:"'required|email'"}],staticClass:"form-input",attrs:{"type":"text","name":"email","placeholder":"your@email.com","maxlength":"80","id":"registration_email"},domProps:{"value":(_vm.email)},on:{"input":function($event){if($event.target.composing){ return; }_vm.email=$event.target.value}}})]),_vm._v(" "),(_vm.errors.has('email'))?_c('span',{staticClass:"validate-error"},[_vm._v(_vm._s(_vm.errors.first('email')))]):_vm._e(),_vm._v(" "),_c('div',{class:[{ 'input-iserror': _vm.errors.has('password')}, { 'input-issucces': _vm.validPassword }, 'custom-input', 'm--custom-input--password' ]},[_c('div',{staticClass:"input-password--wrapper"},[_c('label',{staticClass:"form-label",attrs:{"for":"registration_password"}},[_vm._v(" "+_vm._s(_vm.$locale({i: 'forms.password'})))]),_vm._v(" "),((_vm.showPassword)==='checkbox')?_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.password),expression:"password"},{name:"validate",rawName:"v-validate",value:('required|min:6'),expression:"'required|min:6'"}],staticClass:"form-input",attrs:{"name":"password","maxlength":"255","id":"registration_password","type":"checkbox"},domProps:{"checked":Array.isArray(_vm.password)?_vm._i(_vm.password,null)>-1:(_vm.password)},on:{"change":function($event){var $$a=_vm.password,$$el=$event.target,$$c=$$el.checked?(true):(false);if(Array.isArray($$a)){var $$v=null,$$i=_vm._i($$a,$$v);if($$el.checked){$$i<0&&(_vm.password=$$a.concat([$$v]))}else{$$i>-1&&(_vm.password=$$a.slice(0,$$i).concat($$a.slice($$i+1)))}}else{_vm.password=$$c}}}}):((_vm.showPassword)==='radio')?_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.password),expression:"password"},{name:"validate",rawName:"v-validate",value:('required|min:6'),expression:"'required|min:6'"}],staticClass:"form-input",attrs:{"name":"password","maxlength":"255","id":"registration_password","type":"radio"},domProps:{"checked":_vm._q(_vm.password,null)},on:{"change":function($event){_vm.password=null}}}):_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.password),expression:"password"},{name:"validate",rawName:"v-validate",value:('required|min:6'),expression:"'required|min:6'"}],staticClass:"form-input",attrs:{"name":"password","maxlength":"255","id":"registration_password","type":_vm.showPassword},domProps:{"value":(_vm.password)},on:{"input":function($event){if($event.target.composing){ return; }_vm.password=$event.target.value}}})]),_vm._v(" "),_c('div',{staticClass:"button-showpassword",on:{"click":function($event){_vm.showPasswordflag = !_vm.showPasswordflag}}},[_vm._v("")])]),_vm._v(" "),(_vm.errors.has('password'))?_c('span',{staticClass:"validate-error"},[_vm._v(_vm._s(_vm.errors.first('password')))]):_vm._e(),_vm._v(" "),_c('button',{directives:[{name:"localize",rawName:"v-localize",value:({i: 'forms.singinbutton'}),expression:"{i: 'forms.singinbutton'}"}],staticClass:"form-submit-button",on:{"click":_vm.validateLogin}},[_vm._v("Sing in now ")])])}
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-32d9f91b", __vue__options__)
  } else {
    hotAPI.reload("data-v-32d9f91b", __vue__options__)
  }
})()}
},{"vue":14,"vue-hot-reload-api":9}],17:[function(require,module,exports){
;(function(){
//
//
//
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('form',{staticClass:"form",attrs:{"method":"post"}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.step === 1),expression:"step === 1"}],staticClass:"form-step-wrapper"},[_c('div',{class:[{ 'input-iserror': _vm.errors.has('email')}, {'input-preload' : _vm.emailValidationPreloader}, { 'input-issucces': _vm.validEmail }, 'custom-input' ]},[_c('label',{staticClass:"form-label",attrs:{"for":"registration_email"}},[_vm._v("email")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.$store.user.email),expression:"$store.user.email"},{name:"validate",rawName:"v-validate",value:('required|email'),expression:"'required|email'"}],staticClass:"form-input",attrs:{"type":"text","name":"email","placeholder":"your@email.com","maxlength":"80","id":"registration_email"},domProps:{"value":(_vm.$store.user.email)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.$store.user, "email", $event.target.value)}}})]),_vm._v(" "),(_vm.errors.has('email'))?_c('span',{staticClass:"validate-error"},[_vm._v(_vm._s(_vm.errors.first('email')))]):_vm._e(),_vm._v(" "),_c('div',{class:[{ 'input-iserror': _vm.errors.has('password')}, { 'input-issucces': _vm.validPassword }, 'custom-input', 'm--custom-input--password' ]},[_c('div',{staticClass:"input-password--wrapper"},[_c('label',{staticClass:"form-label",attrs:{"for":"registration_password"}},[_vm._v(" password")]),_vm._v(" "),((_vm.showPassword)==='checkbox')?_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.$store.user.password),expression:"$store.user.password"},{name:"validate",rawName:"v-validate",value:('required|min:6'),expression:"'required|min:6'"}],staticClass:"form-input",attrs:{"name":"password","maxlength":"255","id":"registration_password","type":"checkbox"},domProps:{"checked":Array.isArray(_vm.$store.user.password)?_vm._i(_vm.$store.user.password,null)>-1:(_vm.$store.user.password)},on:{"change":function($event){var $$a=_vm.$store.user.password,$$el=$event.target,$$c=$$el.checked?(true):(false);if(Array.isArray($$a)){var $$v=null,$$i=_vm._i($$a,$$v);if($$el.checked){$$i<0&&(_vm.$set(_vm.$store.user, "password", $$a.concat([$$v])))}else{$$i>-1&&(_vm.$set(_vm.$store.user, "password", $$a.slice(0,$$i).concat($$a.slice($$i+1))))}}else{_vm.$set(_vm.$store.user, "password", $$c)}}}}):((_vm.showPassword)==='radio')?_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.$store.user.password),expression:"$store.user.password"},{name:"validate",rawName:"v-validate",value:('required|min:6'),expression:"'required|min:6'"}],staticClass:"form-input",attrs:{"name":"password","maxlength":"255","id":"registration_password","type":"radio"},domProps:{"checked":_vm._q(_vm.$store.user.password,null)},on:{"change":function($event){_vm.$set(_vm.$store.user, "password", null)}}}):_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.$store.user.password),expression:"$store.user.password"},{name:"validate",rawName:"v-validate",value:('required|min:6'),expression:"'required|min:6'"}],staticClass:"form-input",attrs:{"name":"password","maxlength":"255","id":"registration_password","type":_vm.showPassword},domProps:{"value":(_vm.$store.user.password)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.$store.user, "password", $event.target.value)}}})]),_vm._v(" "),_c('div',{staticClass:"button-showpassword",on:{"click":function($event){_vm.showPasswordflag = !_vm.showPasswordflag}}},[_vm._v("")])]),_vm._v(" "),(_vm.errors.has('password'))?_c('span',{staticClass:"validate-error"},[_vm._v(_vm._s(_vm.errors.first('password')))]):_vm._e(),_vm._v(" "),_c('router-link',{staticClass:"form-links",attrs:{"to":"/singin"}},[_vm._v("Already have an account?")]),_vm._v(" "),_c('input',{staticClass:"form-submit-button",attrs:{"type":"submit","name":"","value":"SING UP NOW"},on:{"click":_vm.validateFirstStep}})],1),_vm._v(" "),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.step === 2),expression:"step === 2"}]},[_c('div',{class:[{ 'input-iserror': _vm.errors.has('name')}, 'custom-input' ]},[_c('label',{staticClass:"form-label",attrs:{"for":"registration_name"}},[_vm._v("name")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.$store.user.first_name),expression:"$store.user.first_name"},{name:"validate",rawName:"v-validate",value:('required|alpha'),expression:"'required|alpha'"}],staticClass:"form-input",attrs:{"type":"text","name":"name","maxlength":"30","id":"registration_name"},domProps:{"value":(_vm.$store.user.first_name)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.$store.user, "first_name", $event.target.value)}}})]),_vm._v(" "),(_vm.errors.has('name'))?_c('span',{staticClass:"validate-error"},[_vm._v(_vm._s(_vm.errors.first('name')))]):_vm._e(),_vm._v(" "),_c('div',{class:[{ 'input-iserror': _vm.errors.has('lastname')}, 'custom-input' ]},[_c('label',{staticClass:"form-label",attrs:{"for":"registration_lastname"}},[_vm._v("last name")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.$store.user.last_name),expression:"$store.user.last_name"},{name:"validate",rawName:"v-validate",value:('required|alpha'),expression:"'required|alpha'"}],staticClass:"form-input",attrs:{"name":"lastname","type":"text","maxlength":"30","id":"registration_lastname"},domProps:{"value":(_vm.$store.user.last_name)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.$store.user, "last_name", $event.target.value)}}})]),_vm._v(" "),(_vm.errors.has('lastname'))?_c('span',{staticClass:"validate-error"},[_vm._v(_vm._s(_vm.errors.first('lastname')))]):_vm._e(),_vm._v(" "),_c('div',{staticClass:"m--birthdate-and-sex--wrapper"},[_c('div',{class:[{ 'input-iserror': _vm.errors.has('birthdate')}, 'custom-input', 'm--custom-input--birthdate' ]},[_c('label',{staticClass:"form-label",attrs:{"for":"registration_birthdate"}},[_vm._v("birthdate")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.$store.user.birthdate),expression:"$store.user.birthdate"},{name:"validate",rawName:"v-validate",value:('date_format:DD.MM.YYYY|date_between:01.01.1938,01.01.2006|required'),expression:"'date_format:DD.MM.YYYY|date_between:01.01.1938,01.01.2006|required'"}],staticClass:"form-input ",attrs:{"type":"text","name":"birthdate","placeholder":"1.1.2018","id":"registration_birthdate"},domProps:{"value":(_vm.$store.user.birthdate)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.$store.user, "birthdate", $event.target.value)}}})]),_vm._v(" "),_c('div',{staticClass:"m--sex--wrapper"},[_c('div',{class:[{ 'input-sex-selected': _vm.activeMan }, 'input-sex' ],on:{"click":_vm.selectMan}},[_vm._v("")]),_vm._v(" "),_c('div',{class:[{ 'input-sex-selected': _vm.activeWoman }, 'input-sex' ],on:{"click":_vm.selectWoman}},[_vm._v("")])])]),_vm._v(" "),(_vm.errors.has('birthdate'))?_c('span',{staticClass:"validate-error"},[_vm._v(_vm._s(_vm.errors.first('birthdate')))]):_vm._e(),_vm._v(" "),_c('input',{staticClass:"form-submit-button",attrs:{"type":"submit","name":"","value":"NEXT"},on:{"click":_vm.validateSecondStep}})]),_vm._v(" "),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.step === 3),expression:"step === 3"}]},[_c('div',{staticClass:"zaglushka"},[_vm._v("We are build you account")])])])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-16253c65", __vue__options__)
  } else {
    hotAPI.reload("data-v-16253c65", __vue__options__)
  }
})()}
},{"vue":14,"vue-hot-reload-api":9}],18:[function(require,module,exports){
;(function(){
//
//
//
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"lv-wrapper"},[_c('lava-profile')],1)}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-a44d6702", __vue__options__)
  } else {
    hotAPI.reload("data-v-a44d6702", __vue__options__)
  }
})()}
},{"vue":14,"vue-hot-reload-api":9}],19:[function(require,module,exports){
;(function(){
//
//
//
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-63b44dc3", __vue__options__)
  } else {
    hotAPI.reload("data-v-63b44dc3", __vue__options__)
  }
})()}
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b296e038", __vue__options__)
  } else {
    hotAPI.reload("data-v-b296e038", __vue__options__)
  }
})()}
},{"vue":14,"vue-hot-reload-api":9}],22:[function(require,module,exports){
;(function(){
//
//
//
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"lv-settings--menu"},[_vm._m(0),_vm._v(" "),_c('div',{staticClass:"lv-settings-nav--block"},[_c('span',{staticClass:"lv-settings-nav--title"},[_vm._v("Settings")]),_vm._v(" "),_c('div',{staticClass:"lv-setting-nav--links"},[_c('router-link',{staticClass:"lv-settings-nav--link icn-settings-line ",attrs:{"to":"/settings","href":"#"},on:{"click":function($event){}}},[_vm._v("General settings")]),_vm._v(" "),_c('router-link',{staticClass:"lv-settings-nav--link icn-settings-lock-line",attrs:{"to":"/settings/privacy","href":"#"}},[_vm._v("Privacy")]),_vm._v(" "),_c('router-link',{staticClass:"lv-settings-nav--link icn-settings-bell-line",attrs:{"to":"/settings/notification","href":"#"}},[_vm._v("Notification")]),_vm._v(" "),_c('router-link',{staticClass:"lv-settings-nav--link icn-settings-blacklist-line",attrs:{"to":"/settings/blacklist","href":"#"}},[_vm._v("Blacklist")]),_vm._v(" "),_c('router-link',{staticClass:"lv-settings-nav--link icn-settings-repassword",attrs:{"to":"/settings/password","href":"#"}},[_vm._v("Password")])],1),_vm._v(" "),_vm._m(1)])])}
__vue__options__.staticRenderFns = [function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"lv-settings--photo"},[_c('a',{staticClass:"lv-userinfo--avatar",attrs:{"href":"#"}},[_vm._v(" AB ")]),_vm._v(" "),_c('a',{staticClass:"lv-settings-changephoto-button icn-camera-pink",attrs:{"href":"#"}},[_vm._v("Change profile photo")])])},function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"lv-settings-logout-wrap"},[_c('a',{staticClass:"lv-settings-nav--link--logout icn-logout",attrs:{"href":"#"}},[_vm._v("Log out")]),_vm._v(" "),_c('div',{staticClass:"lv-settings--langselect-wrapper"},[_c('div',{staticClass:"lv-lang-button--current"},[_vm._v("eng")]),_vm._v(" "),_c('div',{staticClass:"lv-lang-dropup"},[_c('div',{staticClass:"lv-lang-dropup--items"},[_c('a',{staticClass:"lv-lang-select-item",attrs:{"href":"#"}},[_vm._v(" eng")]),_vm._v(" "),_c('a',{staticClass:"lv-lang-select-item",attrs:{"href":"#"}},[_vm._v("рус")])])])])])}]
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3fbdf293", __vue__options__)
  } else {
    hotAPI.reload("data-v-3fbdf293", __vue__options__)
  }
})()}
},{"vue":14,"vue-hot-reload-api":9}],23:[function(require,module,exports){
;(function(){
//
//
//
...
module.exports = {
	data: function() {
		return {
			friends: this.$store.userinfo.notify.friends.email,
			messages: this.$store.userinfo.notify.messages.email,
			media_email: this.$store.userinfo.notify.media.email,
			posts_email: this.$store.userinfo.notify.posts.email,
			mentions_email: this.$store.userinfo.notify.mentions.email,
		...
		changeFriends: function(){
			...
			if(!this.friends_preload){
				...
				this.friends_preload = true
			       ...
			       this.$http.get(this.$store.api.usersetinfo, {params: {notify_friends_email: friends_status}, headers: {'X-Auth-Token': this.$store.api.token}}).then( function(response)  {				          
			       	  this.friends = !this.friends
			          // ответ получен
			          this.$store.userinfo.notify.friends.email = this.friends
		...
		changeMessages: function(){
			...
			if(!this.messages_preload){
				...
				this.messages_preload = true
			       ...
			       this.$http.get(this.$store.api.usersetinfo, {params: {notify_messages_email: messages_status}, headers: {'X-Auth-Token': this.$store.api.token}}).then( function(response)  {				          
			       	  this.messages = !this.messages
			          // ответ получен
			          this.$store.userinfo.notify.messages.email = this.messages
		...
		changeMedia: function(){
			...
			if(!this.media_preload){
				...
				this.media_preload = true
			       ...
			       this.$http.get(this.$store.api.usersetinfo, {params: {notify_media_email: media_status}, headers: {'X-Auth-Token': this.$store.api.token}}).then( function(response)  {				          
			       	  this.media_email = !this.media_email
			          // ответ получен
			          this.$store.userinfo.notify.media.email = this.media_email
		...
		changePosts: function(){
			...
			if(!this.posts_preload){
				...
				this.posts_preload = true
			       ...
			       this.$http.get(this.$store.api.usersetinfo, {params: {notify_posts_email: posts_status}, headers: {'X-Auth-Token': this.$store.api.token}}).then( function(response)  {				          
			       	  this.posts_email = !this.posts_email
			          // ответ получен
			          this.$store.userinfo.notify.posts.email = this.posts_email
		...
		changeMentions: function(){
			...
			if(!this.mentions_preload){
				...
				this.mentions_preload = true
			       ...
			       this.$http.get(this.$store.api.usersetinfo, {params: {notify_mentions_email: mentions_status}, headers: {'X-Auth-Token': this.$store.api.token}}).then( function(response)  {				          
			       	  this.mentions_email = !this.mentions_email
			          // ответ получен
			          this.$store.userinfo.notify.mentions.email = this.mentions_email
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"lv-settings-content--wrapper"},[_c('h2',{staticClass:"lv-settings-content--title"},[_vm._v("Notificate me on mail")]),_vm._v(" "),_c('div',{staticClass:"lv-settings-content-form--wrapper"},[_c('div',{staticClass:"lv-settings-notice--wrapper"},[_c('span',{staticClass:"lv-settings-notice--title"},[_vm._v("General")]),_vm._v(" "),_c('div',{staticClass:"lv-settings-notice--item-wrap"},[_c('div',{staticClass:"lv-settings-notice--item-title"},[_vm._v("Request to followers")]),_vm._v(" "),_c('div',{class:[{'lv-settings-notice--cheker-off' : !_vm.friends }, {'lv-settings-notice--cheker-preload' : _vm.friends_preload }, 'lv-settings-notice--checker'],attrs:{"id":""},on:{"click":_vm.changeFriends}},[_c('div',{staticClass:"lv-settings-notice--cheker-circle"})])]),_vm._v(" "),_c('div',{staticClass:"lv-settings-notice--item-wrap"},[_c('div',{staticClass:"lv-settings-notice--item-title"},[_vm._v("Personal messages")]),_vm._v(" "),_c('div',{class:[{'lv-settings-notice--cheker-off' : !_vm.messages }, {'lv-settings-notice--cheker-preload' : _vm.messages_preload }, 'lv-settings-notice--checker'],on:{"click":_vm.changeMessages}},[_c('div',{staticClass:"lv-settings-notice--cheker-circle"})])])]),_vm._v(" "),_c('div',{staticClass:"lv-settings-notice--wrapper"},[_c('span',{staticClass:"lv-settings-notice--title"},[_vm._v("Comments")]),_vm._v(" "),_c('div',{staticClass:"lv-settings-notice--item-wrap"},[_c('div',{staticClass:"lv-settings-notice--item-title"},[_vm._v("Comments of the photo/video")]),_vm._v(" "),_c('div',{class:[{'lv-settings-notice--cheker-off' : !_vm.media_email }, {'lv-settings-notice--cheker-preload' : _vm.media_preload }, 'lv-settings-notice--checker'],attrs:{"id":""},on:{"click":_vm.changeMedia}},[_c('div',{staticClass:"lv-settings-notice--cheker-circle"})])]),_vm._v(" "),_c('div',{staticClass:"lv-settings-notice--item-wrap"},[_c('div',{staticClass:"lv-settings-notice--item-title"},[_vm._v("Comments of the posts")]),_vm._v(" "),_c('div',{class:[{'lv-settings-notice--cheker-off' : !_vm.posts_email }, {'lv-settings-notice--cheker-preload' : _vm.posts_preload },{'lv-settings-notice--cheker-preload' : _vm.posts_preload }, 'lv-settings-notice--checker'],on:{"click":_vm.changePosts}},[_c('div',{staticClass:"lv-settings-notice--cheker-circle"})])])]),_vm._v(" "),_c('div',{staticClass:"lv-settings-notice--wrapper"},[_c('span',{staticClass:"lv-settings-notice--title"},[_vm._v("Other")]),_vm._v(" "),_c('div',{staticClass:"lv-settings-notice--item-wrap"},[_c('div',{staticClass:"lv-settings-notice--item-title"},[_vm._v("Mention in posts")]),_vm._v(" "),_c('div',{class:[{'lv-settings-notice--cheker-off' : !_vm.mentions_email }, {'lv-settings-notice--cheker-preload' : _vm.mentions_preload },'lv-settings-notice--checker'],attrs:{"id":""},on:{"click":_vm.changeMentions}},[_c('div',{staticClass:"lv-settings-notice--cheker-circle"})])])])])])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-086da862", __vue__options__)
  } else {
    hotAPI.reload("data-v-086da862", __vue__options__)
  }
})()}
},{"vue":14,"vue-hot-reload-api":9}],25:[function(require,module,exports){
;(function(){
//
//
//
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('header',{staticClass:"lv-header"},[_c('div',{staticClass:"lv-logotype"},[_c('router-link',{staticClass:"lv-logotype--link",attrs:{"to":"/"}},[_c('img',{staticClass:"lv-logo",attrs:{"src":"assets/imgs/logo-color.svg"}}),_vm._v("LAVA")])],1),_vm._v(" "),_vm._m(0),_vm._v(" "),_vm._m(1)])}
__vue__options__.staticRenderFns = [function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('form',{staticClass:"lv-search"},[_c('input',{staticClass:"lv-search--input icn-search--bg",attrs:{"type":"text","name":"search","placeholder":"Search","maxlength":"100"}})])},function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('nav',{staticClass:"lv-nav"},[_c('a',{staticClass:"lv-nav--link icn-news--bg",attrs:{"href":"#"}},[_vm._v("news")]),_vm._v(" "),_c('a',{staticClass:"lv-nav--link icn-message--bg",attrs:{"href":"#"}},[_vm._v("messages")]),_vm._v(" "),_c('a',{staticClass:"lv-nav--link icn-add--bg",attrs:{"href":"#"}},[_vm._v("add")]),_vm._v(" "),_c('a',{staticClass:"lv-nav--link icn-bell--bg",attrs:{"href":"#"}},[_vm._v("notify")]),_vm._v(" "),_c('a',{staticClass:"lv-nav--link lv-nav--link__profile",attrs:{"href":"#"}},[_vm._v("profile")])])}]
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-53393786", __vue__options__)
  } else {
    hotAPI.rerender("data-v-53393786", __vue__options__)
  }
})()}
},{"vue":14,"vue-hot-reload-api":9}],27:[function(require,module,exports){
;(function(){
//
//
//
		...
		data: function() {
	  	...
	  	methods: {
		    ...
		    initialize: function() {
		    	...
		    	// если актуальный отображаем
		    	// если нет то отображаем с сервера
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-86a7d5ae", __vue__options__)
  } else {
    hotAPI.rerender("data-v-86a7d5ae", __vue__options__)
  }
})()}
},{"vue":14,"vue-hot-reload-api":9}],28:[function(require,module,exports){
;(function(){
//
//
//
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"preloader"})}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7d2f2d27", __vue__options__)
  } else {
    hotAPI.reload("data-v-7d2f2d27", __vue__options__)
  }
})()}
},{"vue":14,"vue-hot-reload-api":9}],29:[function(require,module,exports){
;(function(){
//
//
//
...
// если залогинен редирект на профиль
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"auth_wrapper"},[_c('auth-header'),_vm._v(" "),_c('div',{staticClass:"auth_main"},[_c('div',{staticClass:"auth_forms"},[_vm._m(0),_vm._v(" "),_c('div',{staticClass:"auth-links--wrapper"},[_c('router-link',{directives:[{name:"localize",rawName:"v-localize",value:({i: 'auth.singin'}),expression:"{i: 'auth.singin'}"}],staticClass:"auth-links",attrs:{"to":"/singin"}},[_vm._v("Sing in")]),_vm._v(" "),_c('router-link',{directives:[{name:"localize",rawName:"v-localize",value:({i: 'auth.singup'}),expression:"{i: 'auth.singup'}"}],staticClass:"auth-links auth-links--right",attrs:{"to":"/singup"}},[_vm._v("Sing up")])],1),_vm._v(" "),_c('singin-form')],1)])],1)}
__vue__options__.staticRenderFns = [function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('h1',{staticClass:"auth_h1"},[_vm._v("Welcome "),_c('span',{staticClass:"auth-h1--redline"},[_vm._v("to LAVA")])])}]
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1a8c2f23", __vue__options__)
  } else {
    hotAPI.reload("data-v-1a8c2f23", __vue__options__)
  }
})()}
},{"vue":14,"vue-hot-reload-api":9}],30:[function(require,module,exports){
;(function(){
//
//
//
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"auth_wrapper"},[_c('auth-header'),_vm._v(" "),_c('div',{staticClass:"auth_main"},[_c('div',{staticClass:"auth_forms"},[_vm._m(0),_vm._v(" "),_c('div',{staticClass:"auth-links--wrapper"},[_c('router-link',{directives:[{name:"localize",rawName:"v-localize",value:({i: 'auth.singin'}),expression:"{i: 'auth.singin'}"}],staticClass:"auth-links",attrs:{"to":"/singin"}},[_vm._v("Sing in")]),_vm._v(" "),_c('router-link',{directives:[{name:"localize",rawName:"v-localize",value:({i: 'auth.singup'}),expression:"{i: 'auth.singup'}"}],staticClass:"auth-links auth-links--right",attrs:{"to":"/singup"}},[_vm._v("Sing up")])],1),_vm._v(" "),_c('singup-form')],1)])],1)}
__vue__options__.staticRenderFns = [function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('h1',{staticClass:"auth_h1"},[_vm._v("Welcome "),_c('span',{staticClass:"auth-h1--redline"},[_vm._v("to LAVA")])])}]
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2f228599", __vue__options__)
  } else {
    hotAPI.reload("data-v-2f228599", __vue__options__)
  }
})()}
},{"vue":14,"vue-hot-reload-api":9}]},{},[1]);
